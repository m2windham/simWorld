...
namespace SimWorld.Tests.Quests
{
    ...
    public class QuestRewardTests : ContentTestBase
    {
        ...
        {
            // DifficultyDef.questRewardValueFactor was dormant for want of anything that paid a reward; this
            // sink is its only plausible consumer, so this is the test that keeps it live.
        ...
        public void A_positive_reward_is_never_rounded_out_of_existence()
        {
            ...
            // one outcome this class must never produce is "the quest paid nothing".
        ...
        private static int SilverPaidUnder(DifficultyDef difficulty, float award)
        {
            ...
            QuestRewardPayment payment = sink.Pay(Silvers(award));
