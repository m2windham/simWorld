...
namespace SimWorld.Defs
{
    ...
    public partial class ThingDef
    {
        ...
        /// <summary>Most units one stack of this def holds (RimWorld: <c>ThingDef.stackLimit</c>); pairs with
        /// <see cref="SimWorld.Things.Thing.stackCount"/> and bounds an <c>ItemStack</c> in crafting.</summary>
