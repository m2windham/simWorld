...
namespace SimWorld.Factions
{
    ...
    public class FactionDef : Def
    {
        ...
        /// <summary>Relative weight this faction is picked to raid with, versus other hostile factions. Not
        /// yet consumed — <see cref="Sim.Find.FactionManager"/>'s <c>RandomEnemyFaction</c> (what
        /// <see cref="Director.IncidentWorker_RaidEnemy"/> calls) still picks uniformly among hostile
        /// factions rather than weighting by this field.</summary>
